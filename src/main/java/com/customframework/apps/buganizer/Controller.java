...
public class Controller {
  private static final String TEMPLATE_DIR = "/app/src/main/resources/apps/buganizer/templates";

  public static Response buganizerHandler(Request req) {
    try {
      String html =
          new String(Files.readAllBytes(Paths.get(TEMPLATE_DIR, "buganizer.html")), "UTF-8");
