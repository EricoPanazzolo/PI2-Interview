...
public class Controller {
  private static final String TEMPLATE_DIR = "/app/src/main/resources/apps/docs_portal/templates";

  public static Response docsPortalHandler(Request req) {
    try {
      String html =
          new String(Files.readAllBytes(Paths.get(TEMPLATE_DIR, "docs_portal.html")), "UTF-8");
